...
public class IpConfig {
	...
	public void doDump() {
		...
		System.out.println("-client-private-key: " + getClientPrivateKey());
		System.out.println("-client-public-key:  " + getClientPublicKey());
		System.out.println("-server-public-key:  " + getServerPublicKey());
	...
	public void doHelp() {
		...
		System.out.println("-client-private-key: mandatory. client's private key file.");
		System.out.println("-client-public-key:  mandatory. client's public key file.");
		System.out.println("-server-public-key:  mandatory. server's public key file.");
	...
	/**
	 * Method sets mandatory parameter {@link CONSTANT_PARAMETER_CLIENT_PRIVATE_KEY}
	 * {@value CONSTANT_PARAMETER_CLIENT_PRIVATE_KEY}.
	 * 
	...
	private boolean setClientPrivateKey(Map<String, String> values) {
		...
		logMissingParameterError(IpConfig.CONSTANT_PARAMETER_CLIENT_PRIVATE_KEY);
		return false;
	}

	/**
	 * Method sets mandatory parameter {@link CONSTANT_PARAMETER_CLIENT_PUBLIC_KEY}
	 * {@value CONSTANT_PARAMETER_CLIENT_PUBLIC_KEY}.
	 * 
	 * @param values contains all loaded config parameter values.
	 * @return boolean indicating success or fail.
	 */
	private boolean setClientPublicKey(Map<String, String> values) {
		...
		logMissingParameterError(IpConfig.CONSTANT_PARAMETER_CLIENT_PUBLIC_KEY);
		return false;
	}
	 ...
	 * {@value CONSTANT_PARAMETER_SERVER_PUBLIC_KEY}.
	 * 
	 * @param values contains all loaded config parameter values.
	 * @return boolean indicating success or fail.
	 */
	private boolean setServerPublicKey(Map<String, String> values) {
		...
		logMissingParameterError(IpConfig.CONSTANT_PARAMETER_SERVER_PUBLIC_KEY);
		return false;
	}
